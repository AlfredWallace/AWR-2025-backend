 ...
 */
final class Version20250505161418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rugby_match (id SERIAL NOT NULL, home_team_id INT NOT NULL, away_team_id INT NOT NULL, simulation_id INT NOT NULL, home_score INT NOT NULL, away_score INT NOT NULL, is_world_cup BOOLEAN NOT NULL, "order" INT NOT NULL, points_exchanged DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE simulation (id SERIAL NOT NULL, name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE team (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, abbreviation VARCHAR(10) NOT NULL, external_id VARCHAR(255) NOT NULL, external_alt_id VARCHAR(255) NOT NULL, country_code VARCHAR(10) NOT NULL, points DOUBLE PRECISION NOT NULL, previous_points DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE team_points (id SERIAL NOT NULL, team_id INT NOT NULL, simulation_id INT NOT NULL, "order" INT NOT NULL, points DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
